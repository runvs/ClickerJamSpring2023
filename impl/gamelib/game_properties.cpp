...
jt::Vector2u GP::HudButtonSize() { return jt::Vector2u { 90, 20 }; }
jt::Vector2f GP::HudMenuOffset() { return jt::Vector2f{ GetScreenSize().x/4.0f*3.0f, 0.0f}; }
jt::Vector2f GP::HudMenuMargin() { return jt::Vector2f{5.0f, 5.0f}; }
